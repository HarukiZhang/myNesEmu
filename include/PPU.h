...
namespace nes {
    ...
    private:
        ...
        //clear sprite_present toggle at cycle 65, which is also the first dot for evaluate sprite;
        void CLR_SPRE(){
            //at cycle 65;
            if (!check_render_enabled()) return;
            load_bkgr_shifters();
    ...
    private:
        ...
        static constexpr MICOP micop_mtx[22] = {
            & PPU::IDLE_DOT,& PPU::RENDER_N,
            & PPU::IN_FE_BG,& PPU::V_F_B_SE,& PPU::IN_FE_NT,& PPU::IN_FE_AT,
            & PPU::SP_FETCH,& PPU::INC_HR_P,& PPU::INC_HORI,& PPU::V_F_A_SE,
            & PPU::V_F_N_SE,& PPU::V_F_B_CS,& PPU::V_F_N_CS,& PPU::V_F_A_CS,
            & PPU::RST_HORI,& PPU::RST_VERT,& PPU::INC_VT_P,& PPU::INC_VERT,
            & PPU::CLR_FLAG,& PPU::CLR_SPRE,& PPU::ODD_SKIP,& PPU::FET_NT_N,
        };
